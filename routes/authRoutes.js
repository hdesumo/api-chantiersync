...
// POST /api/auth/login
// Credentials seed: admin@demo.local / admin123
router.post('/auth/login', (req, res) => {
  try {
    ...
    // Payload proche de celui que tu avais déjà
    const payload = {
      ...
      // iat/exp seront ajoutés automatiquement par jwt.sign via options.expiresIn
    };
